...
export default function BVSSummaryTab({ form, disabled }) {
          ...
          <tbody>
            <tr>
              <td className="border px-2 py-[2px] text-center">
                <Checkbox checked={isIGST} disabled={false} onCheckedChange={handleIGST} />
              </td>
            ...
            <tr>
              <td className="border px-2 py-[2px] text-center">
                <Checkbox checked={isCGSTSGST} disabled={false} onCheckedChange={handleCGSTSGST} />
              </td>

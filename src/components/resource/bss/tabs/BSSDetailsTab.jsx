...
import BSSSRNItemSelectionModal from "../modals/BSSSRNItemSelectionModal";
...
export default function BSSDetailsTab({
  form,
  disabled,
  openItemModal,
  setOpenItemModal,
    ...
    return (
      <>
        <div className="border rounded-sm p-4 text-center text-gray-400">
          Select an Order No from the left panel and add SRN items
        </div>
        <BSSSRNItemSelectionModal
          open={openItemModal}
    ...
    <div className="w-full bg-white">
      <div className="border border-gray-300">
        <div className="w-full bg-[#DCE8D2] border-b border-gray-300 px-4 py-1">
          <h2 className="text-[15px] font-semibold text-black">SRN Items List</h2>
        </div>
              ...
              {items.map((item, index) => {
                ...
                return (
                  <tr key={item.srnItemId ?? index}>
                    ...
                    <TD><ReadCell value={getfmtDisplaydate(item.srnDate)} /></TD>

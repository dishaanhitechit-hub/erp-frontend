      ...
      <style>{`
        ...
        @media print {
          * { -webkit-print-color-adjust: exact !important; print-color-adjust: exact !important; }
          ...
          /*
           * Slide the page-1 content UP by the thead height (78px) so the full
           * first-page header covers the repeated thead logo on page 1.
           * On pages 2+ the tbody div is no longer at top, so the thead logo shows.
           */

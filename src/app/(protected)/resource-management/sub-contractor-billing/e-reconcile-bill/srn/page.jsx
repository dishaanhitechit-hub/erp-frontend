    ...
    <HeaderWrapper header={<PageHeader actions={actions} />}>
      <div className="p-3">
          ...
          actions={
            access.canAdd
              ? [
                  {
                    label: "+ Create BSS",
                    onClick: () => router.push("/resource-management/sub-contractor-billing/e-reconcile-bill/srn/new"),
                  },
                ]
              : []
          }
        ...
        <DataTable
          ...
          data={filteredData}
          onRowClick={(row) => {
            router.push(`/resource-management/sub-contractor-billing/e-reconcile-bill/srn/${row.id}`);
          }}
        />

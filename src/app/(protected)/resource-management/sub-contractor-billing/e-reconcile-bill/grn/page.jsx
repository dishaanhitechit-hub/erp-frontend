    ...
    <HeaderWrapper header={<PageHeader actions={actions} />}>
      <div className="p-3">
          ...
          actions={
            access.canAdd
              ? [
                  {
                    label: "+ Create BVS",
                    onClick: () => router.push("/resource-management/sub-contractor-billing/e-reconcile-bill/grn/new"),
                  },
                ]
              : []
          }
        ...
        <DataTable
          ...
          data={filteredData}
          onRowClick={(row) => {
            router.push(`/resource-management/sub-contractor-billing/e-reconcile-bill/grn/${row.id}`);
          }}
        />

        ...
        children: [
            ...
            },
            {
                ...
                children: [
                    ...
                    { title: "Machinery Stock Summary", moduleCode: "machinery_stock_summary" },
        ...
        children: [
            ...
            { title: "Budget & Costing", moduleCode: "budget_costing" },
            {
                ...
                children: [
                    ...
                    { title: "Daily Progress Report", moduleCode: "daily_progress_report" },
...
const getModuleRowMap = () => {
    ...
    const build = (
        ...
        items.forEach((item, index) => {
            ...
            const moduleCode =
                item.moduleCode ||
                generateModuleCode(title);

            if (
                !HIDDEN_MODULES.includes(moduleCode)
            ) {
...
export default function ApprovalPathPage() {
    ...
    const handleSearch = async () => {
        ...
        try {
            ...
            setProjectTitle(
                matchedProject.clientName || ""
            );

            const usersResponse =
                await apiRequest({
                    url:
                        `${API_ENDPOINTS.SETTINGS.APPROVAL_PATH.GET_USERS_BY_PROJECT}?projectCode=${encodeURIComponent(matchedProject.projectCode)}`,
...
// Build Payload
    ...
    const buildPayload = () => {
        ...
        const modules = tableData
            ...
            .filter(
                (item) =>
                    item.creatorUsers.length > 0 ||
                    item.approverUsers.length > 0
            );
    ...
    const handleSave = async () => {
        ...
        try {
            ...
            toast.success(
                "Approval path saved successfully"
            );
            ...
            <div className="bg-white border shadow-lg p-8">
                ...
                <div className="max-w-5xl mx-auto mb-8">
                    <div className="grid grid-cols-12 gap-3">
                        ...
                        <Button className="col-span-2" onClick={handleSearch} disabled={loading}>
                    ...
                    <div className="grid grid-cols-12 gap-3 mt-3">
                        ...
                        <label
                            className="col-span-2 bg-sky-100 border rounded px-3 py-2">
                            Project Name
                        </label>

                        <Input disabled value={projectName} className="col-span-8 bg-gray-100"/>
                    </div>
                    ...
                    <div className="grid grid-cols-12 gap-3 mt-3">
                        ...
                        <Input disabled value={projectTitle} className="col-span-8 bg-gray-100"/>
                    </div>
                </div>
